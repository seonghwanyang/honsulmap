...
export const metadata: Metadata = {
  title: '자주 묻는 질문',
  description:
    '혼술맵 서비스에 대한 자주 묻는 질문 모음. 가게 제보·정보 수정, 글쓰기, 실시간 현황 노출 관련 안내.',
...
const FAQS: QA[] = [
  {
    q: '혼술맵은 어떤 서비스인가요?',
    a: '전국의 혼술바와 게스트하우스를 지도 한 곳에 모으고, 각 매장의 실시간 현황을 모아 지금 분위기를 한눈에 보여주는 서비스입니다.',
    aText:
      '전국의 혼술바와 게스트하우스를 지도 한 곳에 모으고, 각 매장의 실시간 현황을 모아 지금 분위기를 한눈에 보여주는 서비스입니다.',
  },
  {
  ...
  },
  {
    ...
    a: '각 게스트하우스가 인스타그램에 보통 공지합니다. 사이트 지도에서 게스트하우스 마커를 누르면 최신 현황이 함께 표시됩니다.',
    aText:
      '각 게스트하우스가 인스타그램에 보통 공지합니다. 사이트 지도에서 게스트하우스 마커를 누르면 최신 현황이 함께 표시됩니다.',
  },
  {
    q: '혼자 가도 어색하지 않나요?',
