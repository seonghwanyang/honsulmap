...
const FAQS: QA[] = [
  {
    q: '혼술맵은 어떤 서비스인가요?',
    a: '전국의 혼술바와 게스트하우스를 지도 한 곳에 모으고, 각 매장 인스타 스토리를 자동으로 가져와 지금 분위기를 한눈에 보여주는 서비스입니다.',
    aText:
      '전국의 혼술바와 게스트하우스를 지도 한 곳에 모으고, 각 매장 인스타 스토리를 자동으로 가져와 지금 분위기를 한눈에 보여주는 서비스입니다.',
  },
  {
